...
<template>
  <div class="px-[5%] flex justify-between mt-10">
    <section class="w-[49%] bg-Primary rounded-[12px] py-8 px-[3%]">
      <h2 class="text-[3rem] leading-[130%] text-white font-black">
        Place your <br />
        order in seconds
      </h2>
      <div class="mt-10">
        ...
        >
          ...
          <span class="text-[0.95rem] font-medium">Download on App Store</span>
        </button>
      </div>
      ...
      <div class="justify-between gap-[10%] flex items-end">
        <section class=" flex flex-col gap-4">
         ...
         <div>
             <button
            class="bg-[#FFC501] border-[3px] border-black py-3 px-8 rounded-[8px] text-[1.05rem] font-black"
          >
            CDNWEB
          </button>
         </div>
          <p class="text-white ">Get  <span class=" text-[#FFC501] font-semibold">₦300</span> off your first order when you use this promo code!</p>
        </section>
        <div>
